...
*/
/*
	Slightly modified by Hiroshige Hayashizaki, 2005/06/08.
	Only captype and flowtype are modified.
*/
/*
	Slightly modified by Takashi Ijiri, 2010/05/15.
	For MFC extension dll.
*/
...
class DLL_EXPORT_IMPORT_KEY Graph
{
public:
	typedef enum
	{
	...
	typedef double captype; /* modified by H. H. */
	/* Type of total flow */
	/* typedef int flowtype; */
	typedef double flowtype; /* modified by H. H. */
